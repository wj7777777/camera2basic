   ...
   // }
    ...
    private inner class OnJpegImageAvailableListener :  ImageReader.OnImageAvailableListener {
        ...
        override fun onImageAvailable(imageReader: ImageReader) {
            ...
            // captureResult = captureResults.take()
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                Log.d("MyDebugger", cameraId + "is assessed")
                ...
                imageReader = ImageReader.newInstance(largest.width, largest.height,
                    ...
                    setOnImageAvailableListener(OnJpegImageAvailableListener(), backgroundHandler)
                }
                ...
                Log.d("MyDebugger", cameraId + "is selected")
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        try {
            Log.d("MyDebugger", "setTorchMode")
            manager.setTorchMode("0", true)
        } catch (e:Exception){
            e.printStackTrace()
            Log.d("MyDebugger", "exception")
